...
FB_VER="2.5"
FTP_URL="https://github.com/FirebirdSQL/firebird/releases/download/R2_5_9/FirebirdCS-2.5.9.27139-0.amd64.tar.gz"
...
#chown -R firebird:firebird /opt/firebird/firebird.conf /opt/firebird/aliases.conf
